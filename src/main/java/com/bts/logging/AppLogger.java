    ...
    */
    public static Logger getLogger() throws RuntimeException {
        ...
        if (LogManager.getLogManager().getLogger(loggerName) == null) {
            ...
            try {
                LogManager.getLogManager().readConfiguration(new FileInputStream("customLogging.properties"));
                FileHandler fileHandler = new FileHandler(dotenv.get("LOG_FILEPATH") + "/" + loggerName + ".log", 1000, 7, true);
